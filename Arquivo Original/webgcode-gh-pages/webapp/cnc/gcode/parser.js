...
define(['libs/jsparse', 'cnc/util'], function (jp, util) {
    ...
    function goHome(line, machineState) {
        var hasX = line['x'] !== undefined;
        var hasY = line['y'] !== undefined;
        var hasZ = line['z'] !== undefined;
        ...
        addPathComponent(createPoint(target), machineState, machineState.travelFeedRate, 'rapid');
    }
    var NON_MODAL = {
        10: dataInput,
        28: goHome
